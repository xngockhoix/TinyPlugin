...
void JniHelpers::jniCommonVoidCall(const char* methodName, const char* classPath, const char* arg0, const char* arg1, const char* arg2, const char* arg3)
{
#if(CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID)
    cocos2d::JniMethodInfo minfo;
    
    bool isHave = cocos2d::JniHelper::getStaticMethodInfo(minfo, classPath, methodName, "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V");
    ...
    if (isHave)
    {
        ...
        minfo.env->CallStaticVoidMethod(minfo.classID, minfo.methodID, stringArg0, stringArg1, stringArg2, stringArg3);
...
void JniHelpers::jniCommonVoidCall(const char* methodName, const char* classPath, const char* arg0, const char* arg1, const char* arg2)
{
#if(CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID)
    cocos2d::JniMethodInfo minfo;
    
    bool isHave = cocos2d::JniHelper::getStaticMethodInfo(minfo, classPath, methodName, "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V");
...
void JniHelpers::jniCommonVoidCall(const char* methodName, const char* classPath, const char* arg0, const char* arg1, const char* arg2, const char* arg3, const char* arg4, const char* arg5)
{
#if(CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID)
    cocos2d::JniMethodInfo minfo;
    
    bool isHave = cocos2d::JniHelper::getStaticMethodInfo(minfo, classPath, methodName, "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V");
    ...
    if (isHave)
    {
        ...
        jstring stringArg3 = minfo.env->NewStringUTF(arg3);
        jstring stringArg4 = minfo.env->NewStringUTF(arg4);
        jstring stringArg5 = minfo.env->NewStringUTF(arg5);
        
        minfo.env->CallStaticVoidMethod(minfo.classID, minfo.methodID, stringArg0, stringArg1, stringArg2, stringArg3, stringArg4, stringArg5);
        ...
        minfo.env->DeleteLocalRef(stringArg3);
        minfo.env->DeleteLocalRef(stringArg4);
        minfo.env->DeleteLocalRef(stringArg5);
    }
...
void JniHelpers::jniCommonVoidCallFixInt(const char *methodName, const char *classPath, int num0, int num1, int num2, int num3, int num4)
{
#if(CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID)
    cocos2d::JniMethodInfo minfo;
    
    bool isHave = cocos2d::JniHelper::getStaticMethodInfo(minfo,classPath,methodName, "(IIIII)V");
    ...
    if (isHave)
    {
        ...
        minfo.env->CallStaticVoidMethod(minfo.classID, minfo.methodID, jNum0, jNum1, jNum2, jNum3, jNum4);
        CCLOG("---> Tim duoc ham.");
        
    } else {
        CCLOG("---> Khong tim duoc ham.");
