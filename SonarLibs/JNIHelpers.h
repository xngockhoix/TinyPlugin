...
public:
    ...
    static 			void 		jniCommonVoidCallFixInt	(const char* methodName, const char* classPath, int num0, int num1, int num2, int num3, int num4);
    ...
    static          void        jniCommonVoidCall(const char* methodName, const char* classPath, const char* arg0, const char* arg1, const char* arg2, const char* arg3);
    ...
    static 			void 		jniCommonVoidCall(const char* methodName, const char* classPath, const char* arg0, const char* arg1, const char* arg2, const char* arg3, const char* arg4, const char* arg5);
